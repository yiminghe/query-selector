...
describe("broken", function () {
  ...
  var a = $("<input type='hidden' value='2' name='foo.baz' id='attrbad1'/><input type='hidden' value='2' name='foo[baz]' id='attrbad2'/>").appendTo("#qunit-fixture");
...
describe("id", function () {
  ...
  it('', function () {
    tmpNode = $("<a id='backslash\\foo'></a>").appendTo("#qunit-fixture");
  });
...
describe("name", function () {
  ...
  describe('name nested', function () {
    var a;
    beforeEach(function () {
      a = $("<div><a id=\"tName1ID\" name=\"tName1\">tName1 A</a><a id=\"tName2ID\" name=\"tName2\">tName2 A</a><div id=\"tName1\">tName1 Div</div></div>")
...
describe("multiple", function () {
  t("Comma Support1", "#fixture h2, #qunit-fixture p", ["qunit-banner", "qunit-userAgent", "firstp", "ap", "sndp", "en", "sap", "first"]);
  t("Comma Support2", "#fixture h2 , #qunit-fixture p", ["qunit-banner", "qunit-userAgent", "firstp", "ap", "sndp", "en", "sap", "first"]);
  t("Comma Support3", "#fixture h2 , #qunit-fixture p", ["qunit-banner", "qunit-userAgent", "firstp", "ap", "sndp", "en", "sap", "first"]);
  t("Comma Support4", "#fixture h2,#qunit-fixture p", ["qunit-banner", "qunit-userAgent", "firstp", "ap", "sndp", "en", "sap", "first"]);
  t("Comma Support5", "#fixture h2,#qunit-fixture p", ["qunit-banner", "qunit-userAgent", "firstp", "ap", "sndp", "en", "sap", "first"]);
  t("Comma Support6", "#fixture h2\t,\r#qunit-fixture p", ["qunit-banner", "qunit-userAgent", "firstp", "ap", "sndp", "en", "sap", "first"]);
});
...
describe("attributes", function () {
  ...
  // Make sure attribute value quoting works correctly. See $ #6093; #6428
  var tmp;
...
describe("pseudo - form", function () {
  ...
  var extraTexts = $("<input id=\"impliedText\"/><input id=\"capitalText\" type=\"TEXT\">").appendTo("#form");
